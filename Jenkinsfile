...
node {
        ...
        stage('Deploy WAR') {
            sshagent(credentials : ['c04df32d-d471-4533-8350-1a46b7e9a4ea']) {
                ...
                sh 'scp /root/.jenkins/workspace/CP-Backend/target/*.war ubuntu@ec2-18-185-174-51.eu-central-1.compute.amazonaws.com:/home/ubuntu/tomcat/apache-tomcat-8.0.27/webapps/'
            }
        }
}
